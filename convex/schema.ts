...
export default defineSchema({
  ...
  scriptRevisionProposals: defineTable({
    channelId: v.id("channels"),
    projectId: v.id("projects"),
    createdByMembershipId: v.id("channelMemberships"),
    baseScriptVersionId: v.id("scriptVersions"),
    baseScriptVersionNumber: v.number(),
    baseDraftHash: v.string(),
  ...
  projectRenderJobs: defineTable({
    channelId: v.id("channels"),
    projectId: v.id("projects"),
    compositionVersionId: v.id("compositionVersions"),
    narrationVersionId: v.id("narrationVersions"),
    createdByMembershipId: v.id("channelMemberships"),
    rangeKind: v.union(v.literal("full"), v.literal("selection")),
    ...
    visualFingerprint: v.optional(v.string()),
    wallTimeMs: v.optional(v.number()),
    ...
    .index("by_project_created", ["projectId", "createdAt"]),
  projectRenderJobEvents: defineTable({
